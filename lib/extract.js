...
var Extractor = (function () {
    function Extractor(options) {
        ...
        this.parenDelimRegex = mkAttrRegex('(', ')', this.options.filterName);
    }
    ...
    Extractor.prototype.extractJs = function (filename, src, lineNumber) {
        ...
        function isGettext(node) {
            // if(node && node.callee && node.type === 'CallExpression' && node.callee.property && node.callee.property.name === 't') {
            //     console.log('isGettext', node);
            // }
            return node !== null &&
    ...
    Extractor.prototype.extractHtml = function (filename, src, lineNumber) {
        var extractHtml = function (src, lineNumber) {
            ...
            $('*').each(function (index, n) {
                ...
                var str = node.html();
                //console.log('processing node', str, n);
                var extracted = {};
                ...
                if (node.is(self.options.attribute)) {
                    //console.log('node is attr', self.options.attribute);
                ...
                function extractValue(attr, node) {
                    //console.log("extractValue", attr, getAttr(attr), node.html());
                    if (attr === 'i18next') {
                ...
                for (var attr in node.attr()) {
                    ...
                    if (possibleAttributes.indexOf(attr) > -1) {
                        ...
                        //console.log('noDelimREgex match', matches, str);
            ...
            //parenDelimRegex
            var parenMatches;
            while (parenMatches = this.parenDelimRegex.exec(src)) {
                var str = parenMatches[2].replace(/\\\'/g, '\'');
                var context = parenMatches[4] ? parenMatches[4].replace(/\\\'/g, '\'') : null;
                console.log('parenRegexMatches', str, context, parenMatches.index, reference(parenMatches.index));
                this.addString(reference(parenMatches.index), str, null, null, context);
            }
            
            var matches;
            while (matches = this.attrRegex.exec(src)) {
                //console.log('attrRegexMatches', matches);
    ...
    Extractor.prototype.toString = function () {
        ...
        for (var j = 0; j < sortedItems.length; j++) {
            // console.log('item', JSON.stringify(sortedItems[j]));
            
            //I'm just saving the text, but there's a lot more here if we wanted it.
            //It's a little weird to co-opt angular-gettext-tools for this, but
            //it mostly does what we need...so whatever for now!
            // item [{"msgid":"Automatically Send Alerts","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Block List","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Document Activity Alerts","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Language","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Log Settings","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Message Editing","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Push Notifications","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Signature","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            // item [{"msgid":"Tutorial","msgctxt":null,"references":["settings/account-info.html"],"msgid_plural":null,"msgstr":[],"comments":[],"extractedComments":[],"flags":{},"obsolete":false,"nplurals":2},0]
            
            result[sortedItems[j][0].msgid] = sortedItems[j][0].msgid;
        }
